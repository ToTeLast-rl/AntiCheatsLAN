...
A native utility mod for **Minecraft 26.1.1** that disables the "Allow Commands" button in the LAN menu.

## ✨ Features
* **Native 26.1.1 Support:** Built for the latest unobfuscated environment.
